...
class Tester(object):
	...
	def __init__(self, model = None, data_loader = None, use_gpu = True, cuda_idx = "cuda:7", trainer = None):
	...
	def to_var(self, x, use_gpu):
		if use_gpu:
			return Variable(torch.from_numpy(x).cuda(self.cuda_idx))
		else:
